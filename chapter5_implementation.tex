...
The following figure shows the initial URL submission interface used to start a scan.
...
The following figure presents the main risk result view with score gauge and label.
...
The following figure highlights runtime behavior indicators such as redirects and external requests.
...
The following figure shows network-level domain classification and overall network risk.
...
The following figure summarizes privacy exposure using cookies, scripts, and fingerprinting signals.
...
The following figure lists detected tracker services and their matched domains.
...
The following figure shows the extension overview tab with the primary risk summary.
...
The following figure presents detailed behavior and privacy insights inside the extension popup.
...
The following figure illustrates how fast mode and caching improve repeated scan performance.
